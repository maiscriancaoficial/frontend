...
interface FiltrosAvataresProps {
  filtros: {
    busca: string;
    tipo: string;
    status?: boolean;
  ...
  onAdicionarAvatar: () => void;
}

export function FiltrosAvatares({ filtros, onAtualizarFiltros, onAdicionarAvatar }: FiltrosAvataresProps) {
